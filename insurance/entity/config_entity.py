...
class DataValidationConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.report_file_path = os.path.join(
            self.data_validation_dir, "report.yaml")  # yaml,json,csv
...
class DataTransformationConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.target_encoder_object_path = os.path.join(
            self.data_transformation_dir, "traget_encoder", TARGET_ENCODER_OBJECT_FILE_NAME)
